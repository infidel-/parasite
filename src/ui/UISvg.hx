...
// panic: surprised face — open eyes + round gaping mouth (inline SVG effect glyph)
  public static function effectPanic(): String
    {
      return '<svg viewBox="0 0 1254 1254" aria-hidden="true">' +
        '<circle cx="626.5" cy="620" r="438.42" fill="none" stroke="currentColor" stroke-width="49.67"/>' + // head outline
        '<circle cx="452" cy="575" r="106.5" fill="currentColor"/>' +   // left eye
        '<circle cx="802" cy="575" r="106.5" fill="currentColor"/>' +   // right eye
        '<circle cx="627.5" cy="854" r="120.21" fill="none" stroke="currentColor" stroke-width="54.09"/></svg>'; // gaping mouth
    }
