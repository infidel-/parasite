...
class Building {
  ...
  public var buriedH:Float = 0;   // transient/render hint: world height of the setback deck this piece rises out of — its box STARTS there (no shaft inside the tier beneath, no ground footprint marker). 0 = stands on the ground
