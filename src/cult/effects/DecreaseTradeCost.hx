// effect that decreases trade cost
package cult.effects;

import cult.Effect;
import game.Game;

class DecreaseTradeCost extends Effect
{
  public var percent: Int;

// creates decrease trade cost effect
  public function new(game: Game, turns: Int)
    {
      super(game, CULT_EFFECT_DECREASE_TRADE_COST, turns);
    }
