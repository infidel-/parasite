// effect that loses cult resources each turn
...
class LoseResource extends Effect
{
  public var resourceType: String;

// creates lose resource effect
  public function new(game: Game, turns: Int, resourceType: String)
    {
      super(game, CULT_EFFECT_LOSE_RESOURCE, turns);
  ...
  public override function turn(cult: Cult, time: Int)
    {
      ...
      cult.resources.dec(resourceType, value);
    }
